...
$mail->Subject = 'Welcome To DraftMyCV | Here is your Ebook';
...
include('ebookEmail.php');  //INCLUDES YOUR PHP PAGE AND EXECUTES THE PHP IN THE FILE
...
if (!$mail->send()) {
    ...
    ?>
  <script>alert('Ebook has been sent in your email id');</script>
  <script>
        window.location = "https://draftmycv.com";
</script>

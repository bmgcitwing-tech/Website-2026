...
$mail->setFrom($_GET['email'], 'bmglobal');
...
$mail->Subject = 'bmglobal | New User Enrolled For Appointment';
...
include('welcomeEmail.php');  //INCLUDES YOUR PHP PAGE AND EXECUTES THE PHP IN THE FILE

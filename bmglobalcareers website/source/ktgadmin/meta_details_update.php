...
<main class="main-content">
    ...
    <div class="container-fluid">
        <div class="page-header d-md-flex justify-content-between align-items-center">
            <h4>Meta Details Update</h4>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb m-t-0">
                    <li class="breadcrumb-item"><a href="#">Master</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Meta Details Update</li>
                </ol>
            </nav>
        </div>
    </div>
			...
			<div class="card">
                <div class="card-body">
					<form id="mainform" method="POST" action="" enctype="multipart/form-data">
						<div class="row">
						<?php
							$sql="select * from tbl_meta_details where meta_details_id='".$_GET['id']."'";
						...
						?>
							<div class="col-md-3">
								<div class="form-group">
									...
									<input type="hidden" id="meta_details_id" name="meta_details_id" value="<?php echo $fetch_sql['meta_details_id']; ?>">
								</div>
							</div>
							...
							<div class="col-md-12 text-center">
								<div class="form-group">
									...
									<a href="meta_details.php"><button type="button" id="cansubmit" class="btn btn-danger">Cancel</button></a>
								</div>
...
$("#photo").change(function(){
	...
	$("#submit").click(function(e){
		...
		if($("#title").val()==''){
			...
			$.ajax({
					type: "POST",
					url: "phpservices/update_meta_details.php",
					dataType:'json',
					...
					success: function(result) {
						if(result.op==1){
							...
							setTimeout(function(){
								window.location.href='meta_details.php';
							},1500);
						}
						else{
							$("#msg").html(result.op);

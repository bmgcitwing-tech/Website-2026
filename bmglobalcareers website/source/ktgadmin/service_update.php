...
<main class="main-content">
    ...
    <div class="container-fluid">
        <div class="page-header d-md-flex justify-content-between align-items-center">
            <h4>Update service Images</h4>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb m-t-0">
                    <li class="breadcrumb-item"><a href="#">Master</a></li>
                    <li class="breadcrumb-item active" aria-current="page">service Images</li>
                </ol>
            </nav>
        </div>
    </div>
			...
			<div class="card">
                <div class="card-body">
					<form id="mainform" method="POST" action="" enctype="multipart/form-data">
						<div class="row">
						<?php
							$sql="select * from tbl_service where service_id='".$_GET['id']."'";
						...
						?>
							...
							<!-- <div class="col-md-3">
								<div class="form-group">
									<label>service Image : <span style="color:red">(Max Size : 300 Kb)</span></label>
							...
							<div class="col-md-3">
								<div class="form-group" id="imgpreview">
									...
									<img src="userdata/images/service/<?php echo $fetch_sql['imgname']; ?>" style="width:110px">
								</div>
							</div> -->
						    <input type="hidden" id="service_id" name="service_id" value="<?php echo $fetch_sql['service_id']; ?>">
							<div class="col-md-6">
										<div class="form-group">
							...
							<div class="col-md-12 text-center">
								<div class="form-group">
									...
									<a href="services.php"><button type="button" id="cansubmit" class="btn btn-danger">Cancel</button></a>
								</div>
...
$("#photo").change(function(){
	...
	$("#submit").click(function(e){
		e.preventDefault();
			...
			$.ajax({
					type: "POST",
					url: "phpservices/update_service.php",
					dataType:'json',

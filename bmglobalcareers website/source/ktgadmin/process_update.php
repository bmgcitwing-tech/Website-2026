...
<main class="main-content">
    ...
    <div class="container-fluid">
        <div class="page-header d-md-flex justify-content-between align-items-center">
            <h4>Update Process Details</h4>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb m-t-0">
                    <li class="breadcrumb-item"><a href="#">Master</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Process Details</li>
                </ol>
            </nav>
        </div>
    </div>
			...
			<div class="card">
                <div class="card-body">
					<form id="mainform" method="POST" action="" enctype="multipart/form-data">
						<div class="row">
						<?php
							$sql="select * from tbl_process where ban_id='".$_GET['id']."'";
						...
						?>
							...
							<div class="col-md-3">
								<div class="form-group" id="imgpreview">
									...
									<img src="userdata/images/banner/<?php echo $fetch_sql['imgname']; ?>" style="width:110px">
								</div>
							</div>
...
$("#photo").change(function(){
	...
	$("#submit").click(function(e){
		...
		if($("#title").val()==''){
			...
			$.ajax({
					type: "POST",
					url: "phpservices/update_process.php",
					dataType:'json',

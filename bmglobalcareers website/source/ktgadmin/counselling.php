						...
						<div class="row">
							<div class="col-md-3">
								<div class="form-group">
									<label>Counselling Center Name:</label>
							...
							<div class="col-md-3">
								<div class="form-group">
									<label>Counselling Center Image : <span style="color:red">(Max Size : 300 Kb)</span></label>
							...
							<div class="col-md-3">
											<div class="form-group">
									<label>Counselling Center Description : </label>
                ...
                <div class="card-body">
                   <table id="detailsgrid" class="table table-striped table-bordered" width="100%" cellspacing="0">
                    ...
                    <tr>
                        ...
                        <th>Counselling Center Image</th>
                        <th>Last&nbsp;Update</th>
                        <th>Action</th>
                    </tr>
                    </thead>
					<tbody>
					<?php    								 
                              $sql = "SELECT *,date_format(create_date,'%d/%m/%Y %H:%i:%s') as create_date,date_format(update_date,'%d/%m/%Y %H:%i:%s') as update_date FROM tbl_counselling_centers WHERE delete_status='NDL' order by ban_id desc";
						...
						<tr>
                            ...
                            <td><img class="img-responsive" src ="userdata/images/banner/<?php echo $fetch_sql['imgname']; ?>" width="100px"></td> 
							<?php 
...
$("#photo").change(function(){
	...
	$(document).on('click','.deleteTriger', function(){
		...
		if (alertmsg == true) {
			$.ajax({
						type: "POST",
						url: "phpservices/counselling_delete.php",
						dataType:'json',
						data: {delid:delid},
						success: function(result) {
							if(result.op==1){

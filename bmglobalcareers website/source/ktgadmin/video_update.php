...
<main class="main-content">
    ...
    <?php
		$sql1="select * from tbl_videos_details where vcat_dt_id='".$_GET['id']."'";
		$exec_sql1=mysqli_query($conn,$sql1);
		$fetch_sql1=mysqli_fetch_array($exec_sql1);
	?>
	<div class="row">
        <div class="col-md-12">
			<div class="card">
                <div class="card-body">
					<form id="mainform" method="POST" action="" enctype="multipart/form-data">
                        ...
                        ?>
                                        <option value="<?php echo str_replace("^","'",$fetch_sql['id']); ?>" <?php if($fetch_sql1['cat_id']==$fetch_sql['id']){ echo "selected"; } ?> ><?php echo str_replace("^","'",$fetch_sql['title']); ?></option>
                        <?php $i++; } ?>
	                                </select>
	                            </div>
	                        </div>
							<div class="col-md-3">
								<div class="form-group">
									<label>Title : </label>
									<input type="text" class="form-control" id="title" name="title" placeholder="Enter Title" value="<?php echo $fetch_sql1['title']; ?>">
								</div>
							</div>
							<div class="col-md-3">
								<div class="form-group">
									<label>Link : </label>
									<input type="text" class="form-control" id="link" name="link" placeholder="Enter Link" value="<?php echo $fetch_sql1['url']; ?>">
							...
							<div class="col-md-12 text-center">
								<div class="form-group">
									...
									<a href="video_details.php"><button type="button" class="btn btn-danger cancelbut" style="font-weight:bold;text-align:center">Cancel</button></a>
								</div>
							</div>
							<div class="col-md-12 text-center">
								<div class="form-group">
...
$.ajax({
		type: "POST",
		url: "phpservices/videos_autobind.php",
		dataType:'JSON',
...
$("#cat_add_but").click(function(){
	...
	$("#submit").click(function(e){
		...
		if($("#link").val()==''){
			...
			$.ajax({
					type: "POST",
					url: "phpservices/update_video.php",
					dataType:'json',

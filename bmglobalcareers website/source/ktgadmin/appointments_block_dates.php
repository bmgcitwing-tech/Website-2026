...
<main class="main-content">
    ...
    <div class="container-fluid">
        <div class="page-header d-md-flex justify-content-between align-items-center">
            <h4>Counselling Appointment Block Date</h4>
        </div>
    </div>
	<div class="row">
        <div class="col-md-12">
						...
						<div class="row">
							<div class="col-md-3">
								<div class="form-group">
									<label>Appointment Block Date:</label>
									<input type="hidden" name="action" value="add" />
									<input type="date" class="form-control" data-date-format="DD MMMM YYYY" id="title" name="block_date" placeholder="Enter Title ">
								</div>
							</div>
			...
			<div class="card">
                <div class="card-body">
                   <table id="detailsgrid" class="table table-striped table-bordered" width="100%" cellspacing="0">
                    ...
                    <tr>
                        <th>S.no</th>
                        <th>Appointment Block Date (mm/dd/YYYY)</th>
					...
					<?php    								 
						...
						<tr>
							<td><?php echo $i; ?></td>
							<td><?php echo date("m/d/Y", strtotime($fetch_sql['block_date'])); ?></td>
...
$("#photo").change(function(){
	...
	$("#submit").click(function(e){
		...
		if($("#title").val()==''){
			...
			$.ajax({
					type: "POST",
					url: "phpservices/add_appointment_block.php",
					dataType:'json',
	...
	$(document).on('click','.deleteTriger', function(){
		...
		if (alertmsg == true) {
			$.ajax({
						type: "POST",
						url: "phpservices/appointment_block_delete.php",
						dataType:'json',
						data: {delid:delid},
						success: function(result) {
							if(result.op==1){

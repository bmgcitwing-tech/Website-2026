	...
	<div class="row">
        <div class="col-md-12">
			<div class="card">
                <div class="card-body">
                	<?php
							$sql="select * from tbl_about where id='1'";
						...
						<div class="row">
							...
							<div class="col-md-3">
								<div class="form-group" id="imgpreview">
									...
									<img src="userdata/images/about/<?php echo $fetch_sql['imgname']; ?>" style="width:110px">
								</div>
							</div>
							<div class="col-md-12">
								<div class="form-group">
							...
							<div class="col-md-12 text-center">
								<div class="form-group">
									...
									<a href="abount.php"><button type="button" id="cansubmit" class="btn btn-danger">Cancel</button></a>
								</div>
...
$.ajax({
		type: "POST",
		url: "phpservices/about_services.php",
		dataType:'json',
		...
		success: function(result) {
			...
			$("#short_description").val(result.op[0]['short_description']);
			$(".page-loader").hide();
	...
	$("#submit").click(function(e){
		...
		if($("#title").val()==''){
			...
			$("#msg").css("color","red").html('* Enter Short Description');
			setTimeout(function(){$("#msg").html('')},3000);
			return false;
		}
			...
			$.ajax({
					type: "POST",
					url: "phpservices/update_about.php",
					dataType:'json',

...
$(document).ready(function() {
    ...
    $('.sweet-insert').on('click', function() {
        swal("Saved!", "Successfully Added!", "success");
    });
    $('.sweet-change').on('click', function() {
        swal("Changed!", "Successfully Changed!", "success");
    });
    $('.sweet-update').on('click', function() {
        swal("Updated!", "Successfully Updated!", "success");
    });
    $('.sweet-warning').on('click', function() {
        swal("Good job!", "You clicked the button!", "warning");
    });
    $('.sweet-error-out-of-stock').on('click', function() {
        swal("Error!", "Out of Stock!", "error");
    });
    $('.sweet-error').on('click', function() {
        swal("Error!", "Receiving Amount Not Greater than Pending Amount!", "error");
    });

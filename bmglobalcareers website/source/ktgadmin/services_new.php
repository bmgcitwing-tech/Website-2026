						...
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
									<label>Title:</label>
									<textarea class="form-control" id="title" rows="3" name="title"><?php echo $fetch_sql['title']; ?></textarea>
								</div>
							</div>
							<div class="col-md-6">
								<div class="form-group">
...
$.ajax({
		type: "POST",
		url: "phpservices/new_services_services.php",
		dataType:'json',
	...
	$("#submit").click(function(e){
		...
		if($("#title").val()==''){
			...
			$.ajax({
					type: "POST",
					url: "phpservices/update_services.php",
					dataType:'json',
					...
					success: function(result) {
						if(result.op==1){
							...
							setTimeout(function(){
								window.location.href='services_new.php';
							},1500);
						}
						else{
							$("#msg").html(result.op);

			...
			<div class="card">
                <div class="card-body">
					<form id="mainform" method="POST" action="" enctype="multipart/form-data">
						<div class="row">
						<?php
							$sql="select * from tbl_team_member where id='".$_GET['id']."'";
						...
						?>
							...
							<div class="col-md-3">
								<div class="form-group" id="imgpreview">
									...
									<img src="userdata/images/team_member/<?php echo $fetch_sql['imgname']; ?>" style="width:110px">
								</div>
							</div>
							...
							<div class="col-md-3">
									...
									<input type="text" class="form-control" id="designation" name="designation" placeholder="Enter Title "value="<?php echo str_replace("^","'",$fetch_sql['designation']); ?>">
								</div>
							</div>
							<div class="col-md-12 text-center">
								<div class="form-group">
									<button type="button" name="submit" id="submit" class="btn btn-success">Update</button>
									<a href="team_details.php"><button type="button" id="cansubmit" class="btn btn-danger">Cancel</button></a>
								</div>
...
$("#photo").change(function(){
	...
	$("#submit").click(function(e){
		...
		if($("#title").val()==''){
			...
			$.ajax({
					type: "POST",
					url: "phpservices/update_team.php",
					dataType:'json',
					...
					success: function(result) {
						if(result.op==1){
							...
							setTimeout(function(){
								window.location.href='team_details.php';
							},1500);
						}
						else{
							$("#msg").html(result.op);

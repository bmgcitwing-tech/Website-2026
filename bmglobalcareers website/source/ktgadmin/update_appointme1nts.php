                    ...
                    <div class="card-body">
                        <form id="mainform" method="POST" action="" enctype="multipart/form-data">
                            <div class="row">
                                    ...
                                    <?php
							$sql="select * from tbl_appointment where ban_id='".$_GET['id']."'";
						...
						?>
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" class="form-control" id="dob"
                                                    name="single-date-picker" placeholder="Enter  Date">
                                        ...
                                        <div class="row form-group">
                                            <label class="control-label col-sm-4" for="twelfth_percentage">12th %
                                                *:</label>
                                            <div class="col-sm-6">
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" class="form-control" id="twelfth_english_percentage"
                                                    placeholder="Enter 12th English %"
                                                    name="twelfth_english_percentage">
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-12 text-center">
                                        <div class="form-group">
                                            ...
                                            <a href="appointment.php"><button type="button" id="cansubmit"
...
$(document).ready(function() {
    ...
    $("#photo").change(function() {
        ...
        if (extFile == "jpg" || extFile == "jpeg" || extFile == "png" || extFile == "JPG" || extFile ==
            "JPEG" || extFile == "PNG") {
            if (numb <= 0.3) {
                $(".page-loader").show();
                var fd = new FormData();
                ...
                setTimeout(function() {
                    $.ajax({
                        ...
                        success: function(result) {
                            ...
                            $("#imgpreview").html(
                                '<label>Image Preview :</label><img src="temp/' +
                                result.op +
            ...
            $("#photo").val('');
            swal("Error!", "* Upload .png, .jpg, .jpeg, .PNG, .JPG, .JPEG file type image only",
                "error");
            return false;
        }
    });
    ...
    $("#submit").click(function(e) {
        ...
        if ($("#title").val() == '') {
            ...
            $.ajax({
                type: "POST",
                url: "phpservices/update_appointment.php",
                dataType: 'json',

...
$sql= "update  tbl_counselling_centers set title='".$title."',imgname='".$photo."',description='".$description."',  updated_by='".$log."',update_date='".date('Y-m-d H:i:s')."' where ban_id='".$_POST['ban_id']."'";

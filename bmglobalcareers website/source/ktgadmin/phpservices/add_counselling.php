...
$sql= "INSERT INTO  tbl_counselling_centers (title,imgname,description,created_by,create_date) VALUES('".$title."','".$_POST['photo_name']."','".$description."','".$log."','".date('Y-m-d H:i:s')."')";

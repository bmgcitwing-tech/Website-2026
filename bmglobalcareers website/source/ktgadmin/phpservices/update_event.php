...
$sql= "update tbl_events set title='".$title."',descp='".$descp."',send_notification='".$send_notification."',event_date='".$event_date."', updated_by='".$log."',update_date='".date('Y-m-d H:i:s')."' where event_id='".$_POST['event_id']."'";

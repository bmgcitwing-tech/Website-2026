...
// 	$final_dest='../userdata/images/meta_details';
...
$sql= "update  tbl_meta_details set title='".$title."',description='".$description."',  updated_by='".$log."',update_date='".date('Y-m-d H:i:s')."' where meta_details_id='".$_POST['meta_details_id']."'";

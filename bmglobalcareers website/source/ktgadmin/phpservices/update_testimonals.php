...
if($_POST['photo_new_name']!=''){
	$final_dest='../userdata/images/testimonals';
...
$sql= "update  tbl_testimonals set title='".$title."',imgname='".$photo."',description='".$description."',  updated_by='".$log."',update_date='".date('Y-m-d H:i:s')."' where ban_id='".$_POST['ban_id']."'";

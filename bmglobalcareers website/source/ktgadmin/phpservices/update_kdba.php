...
$sql= "update tbl_kdba set title='".$title."',cat_id='".$cat_id."',send_notification='".$send_notification."',descp='".$descp."',event_date='".$event_date."', updated_by='".$log."',update_date='".date('Y-m-d H:i:s')."' where kdba_id='".$_POST['kdba_id']."'";
	
$exec_query=mysqli_query($conn, $sql);

if($exec_query){
	if($send_notification==1){
		$notiTitle= "EVENTS"."-".$title."";
		$notiMessage =$descp;

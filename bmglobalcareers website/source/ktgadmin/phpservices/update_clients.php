...
if($_POST['photo_new_name']!=''){
	$final_dest='../userdata/images/clients';
...
$sql= "update  tbl_clients set title='".$title."',imgname='".$photo."', updated_by='".$log."',update_date='".date('Y-m-d H:i:s')."' where clients_id='".$_POST['clients_id']."'";

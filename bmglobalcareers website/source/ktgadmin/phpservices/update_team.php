...
if($_POST['photo_new_name']!=''){
	$final_dest='../userdata/images/team_member';
...
$sql= "update  tbl_team_member set title='".$title."',imgname='".$photo."',designation='".$designation."',  updated_by='".$log."',update_date='".date('Y-m-d H:i:s')."' where id='".$_POST['ban_id']."'";

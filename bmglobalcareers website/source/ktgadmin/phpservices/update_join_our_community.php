...
if($_POST['photo_new_name']!=''){
	$final_dest='../userdata/images/join_our_community';
...
$sql= "update  tbl_join_our_community set title='".$title."',imgname='".$photo."',description='".$description."',  updated_by='".$log."',update_date='".date('Y-m-d H:i:s')."' where ban_id='".$_POST['ban_id']."'";

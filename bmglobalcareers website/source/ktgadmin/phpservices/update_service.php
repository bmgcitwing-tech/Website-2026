...
$description=addslashes($_POST['description']);
 $sql= "update  tbl_service set title='".$title."',imgname='".$photo."',description='".$description."',  updated_by='".$log."',update_date='".date('Y-m-d H:i:s')."' where service_id='".$_POST['service_id']."'";

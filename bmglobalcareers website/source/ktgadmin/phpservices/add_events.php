...
$sql= "INSERT INTO  tbl_events (title,descp,event_date,send_notification,created_by,create_date) VALUES('".$title."','".$descp."','".$event_date."','".$send_notification."','".$log."','".date('Y-m-d H:i:s')."')";

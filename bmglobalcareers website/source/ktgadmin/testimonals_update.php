...
<main class="main-content">
    ...
    <div class="container-fluid">
        <div class="page-header d-md-flex justify-content-between align-items-center">
            <h4>Update Testimonals</h4>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb m-t-0">
                    <li class="breadcrumb-item"><a href="#">Master</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Testimonals</li>
                </ol>
            </nav>
        </div>
    </div>
			...
			<div class="card">
                <div class="card-body">
					<form id="mainform" method="POST" action="" enctype="multipart/form-data">
						<div class="row">
						<?php
							$sql="select * from tbl_testimonals where ban_id='".$_GET['id']."'";
						...
						?>
							<div class="col-md-3">
								<div class="form-group">
									...
									<input type="text" class="form-control" id="title" name="title" placeholder="Enter Name "value="<?php echo str_replace("^","'",$fetch_sql['title']); ?>">
								</div>
							</div>
							<div class="col-md-3">
								<div class="form-group">
									...
									<input type="hidden" id="ban_id" name="ban_id" value="<?php echo $fetch_sql['ban_id']; ?>">
								</div>
							</div>
							<div class="col-md-3">
								<div class="form-group" id="imgpreview">
									<label>Image Preview : </label>
									<img src="userdata/images/testimonals/<?php echo $fetch_sql['imgname']; ?>" style="width:110px">
								</div>
							</div>
							...
							<div class="col-md-3">
										<div class="form-group">
									<label>Message : </label>
									<textarea class="form-control" id="description" rows="3" name="description" style="height: 37px; min-height: 37px; margin-top: 0px; margin-bottom: 0px;"><?php echo $fetch_sql['description']; ?></textarea>
								</div>
							</div>
							<div class="col-md-12 text-center">
								<div class="form-group">
									<button type="button" name="submit" id="submit" class="btn btn-success">Update</button>
									<a href="testimonals.php"><button type="button" id="cansubmit" class="btn btn-danger">Cancel</button></a>
								</div>
...
$("#photo").change(function(){
	...
	$("#submit").click(function(e){
		...
		if($("#title").val()==''){
			...
			$.ajax({
					type: "POST",
					url: "phpservices/update_testimonals.php",
					dataType:'json',

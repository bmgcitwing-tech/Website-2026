			...
			<div class="card">
                <div class="card-body">
					<form id="mainform" method="POST" action="" enctype="multipart/form-data">
						<div class="row">
						<?php
							$sql="select * from tbl_join_our_community where ban_id='".$_GET['id']."'";
						...
						?>
							...
							<div class="col-md-3">
								<div class="form-group">
									<label>Banner Image : <span style="color:red">(Max Size : 300 Kb)</span></label>
							...
							<div class="col-md-3">
								<div class="form-group" id="imgpreview">
									...
									<img src="userdata/images/join_our_community/<?php echo $fetch_sql['imgname']; ?>" style="width:110px">
								</div>
							</div>
							...
							<div class="col-md-12 text-center">
								<div class="form-group">
									...
									<a href="banner_images.php"><button type="button" id="cansubmit" class="btn btn-danger">Cancel</button></a>
								</div>
...
$("#photo").change(function(){
	...
	$("#submit").click(function(e){
		...
		if($("#title").val()==''){
			...
			$.ajax({
					type: "POST",
					url: "phpservices/update_join_our_community.php",
					dataType:'json',
					...
					success: function(result) {
						if(result.op==1){
							...
							setTimeout(function(){
								window.location.href='join_our_community.php';
							},1500);
						}
						else{
							$("#msg").html(result.op);

			...
			<div class="card">
                <div class="card-body">
					<form id="mainform" method="POST" action="" enctype="multipart/form-data">
						<div class="row">
						<?php
							$sql="select * from tbl_clients where clients_id='".$_GET['id']."'";
						...
						?>
							...
							<div class="col-md-3">
								<div class="form-group">
									...
									<input type="hidden" id="clients_id" name="clients_id" value="<?php echo $fetch_sql['clients_id']; ?>">
								</div>
							</div>
							<div class="col-md-2">
								<div class="form-group" id="imgpreview">
									<img src="userdata/images/clients/<?php echo $fetch_sql['imgname']; ?>" style="width:110px">
								</div>
							</div>
							<div class="col-md-2">
								<div class="form-group">
									<button type="button" name="submit" id="submit" class="btn btn-success">Update</button>
									<!--a href="clients.php"><button type="button" id="cansubmit" class="btn btn-danger">Cancel</button></a-->
								</div>
							</div>
...
$("#photo").change(function(){
	...
	$("#submit").click(function(e){
		...
		if($("#title").val()==''){
			...
			$.ajax({
					type: "POST",
					url: "phpservices/update_clients.php",
					dataType:'json',
